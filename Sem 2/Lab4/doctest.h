...
namespace {
    ...
    struct FatalConditionHandler
    {
        ...
        FatalConditionHandler() {
            ...
            // - std::terminate is called FROM THE TEST_CASE RUNNER THREAD
            // - an exception is thrown from a destructor FROM THE TEST_CASE RUNNER THREAD
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void logTestStart() {
            ...
            if(tc->m_test_suite && tc->m_test_suite[0] != '\0')
                s << Color::Yellow << "TEST_CASE SUITE: " << Color::None << tc->m_test_suite << "\n";
            if(strncmp(tc->m_name, "  Scenario:", 11) != 0)
                s << Color::Yellow << "TEST_CASE CASE:  ";
